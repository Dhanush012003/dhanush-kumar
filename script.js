...
document.addEventListener('DOMContentLoaded', () => {
  // Remove any target="_blank" from internal navigation links
...
/* ============ GSAP SCROLL ANIMATIONS - NO OPACITY HIDING ============ */
...
console.log('%c💡 Try the Konami Code: ↑↑↓↓←→←→BA','color:#ff3cac;font-size:14px;');
console.log('%c🤖 Built with AI by Dhanush Kumar S S','color:#ffd700;font-size:14px;');